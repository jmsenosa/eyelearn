...
class DatabaseObject {
  ...
  public static function check_name($name) {
		return static::find_by_sql("SELECT * FROM `".static::$table_name."` WHERE name='{$name}'  ");
  }
   
   public static function clear_table($table='') {
		return static::find_by_sql("TRUNCATE ".$table);
  }
  
  	public static function find_all_active() {
		return static::find_by_sql("SELECT * FROM `".static::$table_name."` WHERE `active`=1 ");
  }
  
  public static function find_all_orderby_name() {
