...
class Student extends DatabaseObject {
	...
	protected static $db_fields = array('id', 'lrn', 'first_name', 'middle_name','parent_first_name','parent_last_name', 'last_name','active', 'last_update','address','sy','section','teacher');
