...
<!-- Page Heading/Breadcrumbs -->
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-user "></i> Grading Management <small></small></h1>
            <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul id="myTab" class="nav nav-tabs nav-justified">
                <li class="active"><a href="#service-one" data-toggle="tab"> Grading Management</a></li> 
            </ul>
                        ...
                        <tbody>
                            <?php if ($result->num_rows > 0) { ?>
                                ...
                                <tr>
                                    ...
                                    <td class='text-center'><?php echo ($student->active == 1) ? '<i class="fa fa-check text-success"></i> Active' : '<i class="fa fa-remove text-danger"></i> Inactive'; ?></td>
                                    <td class='text-right'>
                                        <a href="update.php?id=<?php echo $student->id;?>" role="btn" class="btn btn-primary">Update</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            <?php } ?>
