		...
		<div class="col-md-12">
			...
			<form class="form-horizontal" enctype="multipart/form-data"  method="POST">
			  <div class="form-group">
				...
				<div class="col-sm-4">
				  <input type="text" class="form-control" id="name" name="name" placeholder="<?php echo ucwords($obj); ?> Name"  value="<?php echo $section->section ?>"/>
				</div>
			  ...
			  <div class="form-group">
				<div class="col-sm-offset-2 col-sm-4">
				  <button type="submit" class="btn btn-success" name="submit">Update <?php echo ucwords($obj); ?></button>
				</div>
			  </div>
			</form>
			<hr />
