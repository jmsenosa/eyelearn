...
?>
    <?php include_layout_template('sub_header.php'); ?>
        ...
        <?php if($message):?>
            ...
            <?php else: ?>
                <div class="alert alert-info alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button> <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> There are total of <strong><?php echo count($lessons); ?></strong>
        ...
        if($datetime->format('Y') == date('Y')){
                            ?>
                                <tr>
                                    <td><a href='folder.php?id=<?php echo $lesson->id; ?>' rel="tooltip" title="     View Content"><?php echo ucwords($lesson->name); ?></td>
