<form method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control lettersonly" name="first_name" value="<?php echo (isset($_POST["first_name"])) ? $_POST["first_name"] : (isset($parent->first_name)) ? $parent->first_name : "" ; ?>" id="first_name" placeholder="first_name" required="required">
    </div>
    <div class="form-group">
        <label for="last_name">Last Name</label>
        <input type="text" class="form-control lettersonly" name="last_name" value="<?php echo (isset($_POST["last_name"])) ? $_POST["last_name"] : (isset($parent->last_name)) ? $parent->last_name : "" ; ?>" id="last_name" placeholder="last_name" required="required">
    </div>
    <div class="form-group">
        <label for="phone">Phone Number</label>
        <input type="text" class="form-control numbersonly" minlength="6" name="phone" value="<?php echo (isset($_POST["phone"])) ? $_POST["phone"] : (isset($parent->phone)) ? $parent->phone : "" ; ?>" id="phone" placeholder="phone" required="required" maxlength="11">
    </div>
    <div class="form-group">
