	...
	<div class="row">
		<div class="col-md-3">
			<div class="panel panel-default text-center">
				...
				<div class="panel-body">
					 <h4> <a href="user/index.php" >User Manager</a></h4>
					<p>Teachers and Adminsm </p>
				</div>
			</div>
		</div>
        ...
        <div class="col-md-3">
			<div class="panel panel-default text-center">
				...
				<div class="panel-body">
					 <h4> <a href="student/index.php" >Parents and Students</a></h4>
       ...
       <div class="col-md-3">
        ...
        <div class="col-md-3">
			<div class="panel panel-default text-center">
				...
				<div class="panel-body">
					<h4> <a href="audit/index.php" >Audit Trail</a></h4>
					<p>Audit Trail</p>
				</div>
			</div>
		</div>
