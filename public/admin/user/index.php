		...
		<div class="col-lg-12">
			...
			<div id="myTabContent" class="tab-content">
				<div class="tab-pane fade active in" id="service-one">
					...
					<a href='viewpdf.php?type=admin' target='blank' class="btn btn-danger" >View in PDF Files</a>
				</div>
				<div class="tab-pane fade" id="service-two">
					...
					<a href='viewpdf.php?type=teacher' target='blank' class="btn btn-danger" >View in PDF Files</a>
				</div>
