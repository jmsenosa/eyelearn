	...
	<div class="col-md-12">
		...
		<form class="form-horizontal" action="update.php"  method="POST">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="description" name="description" value='<?php echo ucwords($lesson->description); ?>'  />
				</div>
				<label for="isDone" class="col-sm-2 control-label"> <?php echo ucwords($obj); ?> done</label>
				<div class="col-sm-5">
