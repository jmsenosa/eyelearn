	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class='col-md-6 col-md-offset-3'> 
				<form action="update.php?id=<?php echo @$quiz->id; ?>"  method="POST">
				  <input type="hidden" name="id" value='<?php echo @$quiz->id; ?>' >
				  <div class="form-group">
					<label for="name"><span class='text-danger' >&#42;</span> Name</label>
					<input type="text" class="form-control" name="name" id="name" value='<?php echo @$quiz->name; ?>' >
				  </div>
				    <div class="form-group">
					<label for="description"><span class='text-danger' >&#42;</span> Description</label>
					<input type="text" class="form-control" name="description" id="description" value='<?php echo @$quiz->description; ?>'>
				  </div>
				  <div class="checkbox">
					  <input type="radio" name="active" id="active" value=1  <?php echo $quiz->active==1 ? "checked='checked'":"" ?>   /> Active
					 <input type="radio" name="active" id="active" value=0  <?php echo $quiz->active==0 ? "checked='checked'":"" ?> /> In Active
				  </div>
